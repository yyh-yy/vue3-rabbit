...
const openOreCloseAddress = (flag) => {
  activeAddres.value = curAddress.value;
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="openOreCloseAddress(true)"
                >切换地址</el-button
              >
              <el-button size="large" @click="openOreCloseAddress(false)"
                >添加地址</el-button
              >
            </div>
          </div>
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button type="primary" size="large" @click="submitPayOrder"
            >提交订单</el-button
          >
        </div>
      </div>
